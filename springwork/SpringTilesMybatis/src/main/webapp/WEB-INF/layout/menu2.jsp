	...
	<nav class="navbar">
  		<ul class="navbar_menu">
	    	<li class="navbar_item">
      			<a href="${root}/" class="navbar_link"><i class="bi bi-house"></i><span>Home</span></a>
    		</li>
    		<li class="navbar_item">
      			<a href="${root}/member/form" class="navbar_link"><i class="bi bi-person-add"></i><span>Sign Up</span></a>        
    		</li>
    		<li class="navbar_item">
      			<a href="${root}/login/main" class="navbar_link"><i class="bi bi-person"></i><span>Sign In</span></a>        
    		</li>
    		<li class="navbar_item">
      			<a href="${root}/board/list" class="navbar_link"><i class="bi bi-globe"></i><span>Board</span></a>        
    		</li>
    		<li class="navbar_item">
      			<a href="${root}/guest/list" class="navbar_link"><i class="bi bi-chat-left-text"></i><span>Comments</span></a>        
    		</li>
    		<li class="navbar_item">
      			<a href="${root}/map" class="navbar_link"><i class="bi bi-geo-alt"></i><span>Map</span></a>        
	    	</li>
    		<li class="navbar_item">
      			<a href="#" class="navbar_link"><i class="bi bi-person-dash"></i><span>Sign Out</span></a>        
    		</li>
  		</ul>
	</nav>
