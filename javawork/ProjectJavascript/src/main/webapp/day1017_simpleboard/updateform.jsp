...
<!-- 이미지 출력할곳 -->
 ...
 style="position: absolute;left:600px;top:70px;max-width: 300px;"
 onerror="this.style.display='none';"><!-- error 발생하면 안 보이게 처리 (해당 파일이 없는 경우) -->
...
<div style="margin: 30px 50px;">
	<form action="./updateaction.jsp" method="post" enctype="multipart/form-data">
		...
		<table class="table table-bordered" style="width: 500px;">
			<caption align="top">글 수정</caption>
			<tr>
				<th width="100">작성자</th>
				<td>
