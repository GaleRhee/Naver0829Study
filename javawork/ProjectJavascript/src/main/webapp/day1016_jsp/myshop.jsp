...
<script src="https://code.jquery.com/jquery-3.7.0.js"></script>
 ...
 <script type="text/javascript">
 	$(function(){
 		//작은 이미지 클릭 시 num 얻어서 myshopdetail.jsp 로 이동
 		$("img.small").click(function(){
 			let num=$(this).attr("num");
 			//페이지 이동
 			//location.href="myshopdetail.jsp?num="+num;
 			//es6 의 리터럴 문자 사용 시 - jsp 자체적으로 $ 기능이 있으므로 
 			//앞에 \를 붙여서 변수를 가져온다
 			location.href=`myshopdetail.jsp?num=\${num}`;
...
<div class="input-group" style="width: 600px;">
	<h5 class="alert alert-danger" style="width: 530px;">총 <%=list.size() %>개의 상품이 있습니다</h5>
	<button type="button" class="btn btn-outline-info btn-sm" style="height: 58px;float:right;"
