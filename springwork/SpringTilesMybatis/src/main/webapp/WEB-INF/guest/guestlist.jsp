...
<div>
	...
	<div class="input-group" style="width: 300px;margin-left: 200px;">
		<h6><b>번역할 나라 선택 : </b></h6>
	...
	<c:forEach var="dto" items="${glist}">
		<div class="guest_box">
			...
			<img src="https://uacnc5zz1735.edge.naverncp.com/yyNpgNcOUQ/guest/${dto.guest_photo}?type=f&w=100&h=100&faceopt=true&ttype=jpg" 
...
<script type="text/javascript">
	$("img.smallphoto").click(function(){
		...
		//모달 다이알로그에 사진 넣기
		$("img.largephoto").attr("src",`https://kr.object.ncloudstorage.com/guest-jir/guest/\${photoname}`);
	});
</script>
