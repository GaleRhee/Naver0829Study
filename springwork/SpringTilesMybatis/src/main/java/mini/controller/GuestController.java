...
public class GuestController {
	...
	private String bucketName="guest-jir";
	private String folderName="guest";
	
	//번역 후 반환하는 메서드
	public String translate(String text1,String nara)
	{
		String clientId = "ib8kvi96zm";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "1czNkNF1UC90rUOmFhYnXknr7DnsEKvaSX1i4D07";//애플리케이션 클라이언트 시크릿값";
        String returnValue="";
        try {
            ...
            //message.result.translatedText : json 구조 데이터 추출
	...
	@ResponseBody public String getVoice(String message,String lang,HttpServletRequest request)
	{
		...
		String clientId = "rehak7lqhh";//애플리케이션 클라이언트 아이디값";
        String clientSecret = "TCb100bfxBPQ8fyIniPYtKqd6kodfKRaabmGBjIz";//애플리케이션 클라이언트 시크릿값";
        try {
