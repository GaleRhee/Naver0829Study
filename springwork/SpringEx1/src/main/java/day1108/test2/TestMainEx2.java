...
public class TestMainEx2 {
	...
	public static void main(String[] args) {
		...
		MessageInter m3=(Message1)context.getBean("mes1");//반환 타입이 Object 이므로 타입을 지정하거나 형 변환 해서 타입을 맞춘다
		...
		System.out.println(m3.hashCode()+","+m3_1.hashCode());//singleton 은 여러 번 생성해도 주소가 같다
		System.out.println(m4.hashCode()+","+m4_1.hashCode());//prototype 은 생성할 때마다 주소가 다르다
	}
