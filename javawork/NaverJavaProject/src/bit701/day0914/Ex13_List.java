...
public class Ex13_List {
	...
	public static void main(String[] args) {
		...
		System.out.println("list1 의 할당 개수:"+list1.capacity());
		
		Vector<String> list2=new Vector<String>(5);//기본 5개 할당 (5개씩 증가)
		System.out.println("list2 의 할당 개수:"+list2.capacity());
		
		Vector<String> list3=new Vector<String>(3,2);//기본 3개 할당 (2개씩 증가)
		System.out.println("list3 의 할당 개수:"+list3.capacity());
		list3.add("red");
		list3.add("green");
		list3.add("blue");
		list3.add("pink");
		System.out.println("list3 의 할당 개수:"+list3.capacity());
		System.out.println("list3 의 데이터 개수:"+list3.size());
	}
