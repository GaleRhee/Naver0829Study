...
//import OneApp from './OneApp'; //default 로 export 한 경우
    ...
    return (
        <div>
            ...
            onChange={(e)=>{
                ...
                <option value={5}>FiveApp - checkbox, select 이미지 이벤트</option>
            </select>
            <br/><br/>
            <h5>당신은 {comp} 번 컴포넌트를 선택했습니다</h5>
            {
                //조건 연산자를 이용하여 comp 값에 따라 해당 컴포넌트가
                //나오도록 하기
                comp===1?<OneApp/>: comp===2?<TwoApp/>: comp===3?<ThreeApp/>: 
