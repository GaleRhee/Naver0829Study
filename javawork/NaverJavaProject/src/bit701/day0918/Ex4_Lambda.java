...
@FunctionalInterface
interface Orange //함수형 인터페이스로 쓴다는 뜻
{
...
public class Ex4_Lambda {
	...
	//우리가 알고 있는 익명 내부 클래스 형태로 객체를 생성 해보자
	...
	public void abstMethod2()
	{
		...
		//오버라이드 메서드가 두 줄 이상일 경우 {} 안에서 주면 된다
		Orange or2=()->{
	...
	//람다식으로 오버라이드 해보기
		public void abstMethod3(int x,int y)
		{
			//기존 방식-익명 내부 클래스
