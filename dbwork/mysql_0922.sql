...
-- 데이터 주기
insert into sawon values (null,'이하니',89,'여자','홍보부');
-- 제약 조건 오류 확인하기
...
-- 제대로 된 데이터 7개 추가하기
insert into sawon values (null,'강호동',74,'남자','인사부');
insert into sawon values (null,'한가인',67,'여자','교육부');
insert into sawon values (null,'강하늘',79,'남자','문체부');
insert into sawon values (null,'김영희',93,'여자','인사부');
insert into sawon values (null,'박보영',99,'여자','교육부');
insert into sawon values (null,'최재규',59,'남자','홍보부');
insert into sawon values (null,'이민기',92,'남자','사업부');
...
-- 추출
select left('Have a Nice Day',4) from dual; -- 왼쪽에서 4 글자 추출 : Have
select right('Have a Nice Day',8) from dual; -- 오른쪽에서 8 글자 추출 : Nice Day
select mid('Have a Nice Day',6,6) from dual; -- 6 번부터 6 글자 : a Nice
select substring('Have a Nice Day',6,6) from dual; -- 6 번부터 6 글자 : a Nice
...
select truncate(2.345,2) from dual; -- 소숫점 2 자리까지 출력, 무조건 내림
select mod(7,2) from dual; -- 나머지


-- Group by
-- 부서별 인원 수, 최고 점수, 최저 점수, 평균 점수
...
-- sub table 에 데이터가 추가된 상태에서 부모 테이블의 데이터를 삭제 해보자
