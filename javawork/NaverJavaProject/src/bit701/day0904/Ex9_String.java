...
public class Ex9_String {
	...
	public static void main(String[] args) {
		...
		System.out.println(str3.length());//str3 의 총 길이: 15 (공백 포함)
		...
		System.out.println(str1.indexOf('a'));//str1에서 첫번째 'a'의 인데스 값
		System.out.println(str3.lastIndexOf('a'));//str3에서 마지막 'a'의 인데스 값
		System.out.println(str4.length());//앞뒤 공백을 포함한 전체 길이
		System.out.println(str4.trim().length());//앞뒤 공백을 제거 후 길이 구하기
		System.out.println(str3.startsWith("Have"));//str3가 Have로 시작하면 true
		System.out.println(str3.endsWith("day"));//str3가 day로 끝나면 true (대소문자 정확하게 맞아야 함)
		System.out.println(str1.equals(str2));//;str1이 str2와 대소문자까지 같은 경우 true
