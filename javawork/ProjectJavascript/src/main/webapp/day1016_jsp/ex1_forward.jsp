...
<!-- 
	jsp 에서 페이지 이동하는 방법
	1. forward : url 주소 안 바뀜, request, response 등이 그대로 전달 된다
	2. redirect : url 주소 바뀜, request, response 등이 새로  생성 되므로 전달 안된다
 -->
 
 <h3>forward 를 이용해서 페이지 이동하기</h3>
 <%
 	//request 에 데이터를 저장 해보자
 ...
 <!-- 뒤에 </forward>로 받든지 위처럼 /> 로 닫든지 무조건 맏아 줘야 한다 -->
